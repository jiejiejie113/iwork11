...
$ROLE_CONFIG = @{
    iwork = @{
        RepositoryUrl = 'https://github.com/jiejiejie113/iwork11'
        Repository = 'jiejiejie113/iwork11'
        BranchRef = 'refs/heads/Keycloak'
        WorkflowName = 'iwork production runner smoke'
        WorkflowRef = 'jiejiejie113/iwork11/.github/workflows/runner-smoke.yml@refs/heads/Keycloak'
        RunnerName = 'DTDSERVER-iwork-01'
        Labels = 'dkt-prod,iwork'
        TaskName = 'GitHub-Runner-iwork'
    }
    portal = @{
        RepositoryUrl = 'https://github.com/jiejiejie113/DTD_nginx'
        ...
        WorkflowRef = 'jiejiejie113/DTD_nginx/.github/workflows/runner-smoke.yml@refs/heads/feature/keycloak-migration'
